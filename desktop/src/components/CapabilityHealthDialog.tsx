...
/** Capability lifecycle + failure isolation, rendered inside the right dock. */
export function CapabilityHealthContent({
  plugins,
  states,
  lifecycle,
  running,
  ...
  return (
    <div className="dock-capability">
      ...
      <div className="dock-scroll capability-health-body">
        ...
        <section className="capability-lifecycle">
          <h4>生命周期</h4>
          {lifecycle.length === 0 ? (
            <div className="dock-empty">此会话还没有 capability 生命周期事件。</div>
          ) : (
